...
\subsection{Acceptance Testing for Bot}
		
\paragraph{Acceptance Tests}
Testing will focus on non-functional qualities of the bot. Customers will include the development team and members outside of the project to guage effectiveness.
...
Input: Customer inputs command
					
Output: Expected output of customer
					
How test will be performed: Customers will be given a sheet of commands to the bot. They will be asked to try some commands. Ease of use and learnability will be measured by customer's qualitative response.
...
How test will be performed:  Create a script of bot commands. Run script. Check if commands output at a reasonable speed. 
